...
if gnssId == 0  % GPS
    figure(1)
    set(gcf, 'Position', [50, 100, 1700, 460]); % 设置Figure窗口的位置和大小
    m=1; n=4;
    dim=32;gnss="G";
...
subplot('position', [0.79 0.15 subplotWid subplotht])
    ...
    xticklabels(xticklabels1)
    xlabel('(d)');hold off;
    saveas(gcf,'longTerm_GPS_sat_obs.png')
    
    % display the skyplot
    elev = elev_G';azim = azim_G';
    satSkyPlot(gnssId,elev,azim,sats)
    saveas(gcf, 'longTerm_GPS_satSkyPlot.png')
end
...
subplot('position', [0.79 0.15 subplotWid subplotht])
    ...
    xticklabels(xticklabels1)
    xlabel('(d)');hold off;
    saveas(gcf,'longTerm_Galileo_sat_obs.png')

    % display the skyplot
    elev = elev_E';azim = azim_E';
    satSkyPlot(gnssId,elev,azim,sats)
    saveas(gcf, 'longTerm_Galileo_satSkyPlot.png')
end
...
subplot('position', [0.79 0.15 subplotWid subplotht])
    ...
    xticklabels(xticklabels1)
    xlabel('(d)');hold off;
    saveas(gcf,'longTerm_BDS_sat_obs.png')

    % display the skyplot
    elev = elev_B';azim = azim_B';
    satSkyPlot(gnssId,elev,azim,sats)
    saveas(gcf, 'longTerm_BDS_satSkyPlot.png')
end

if gnssId == 5
    figure(1)
    set(gcf, 'Position', [100, 100, 1600, 460]); % 设置Figure窗口的位置和大小
    m=1; n=4;
    dim=10;gnss='Q';
    lgds = {};clgd = 0;LineWidth1=1.8;
    subplot('position', [0.05 0.15 subplotWid subplotht])
...
subplot('position', [0.79 0.15 subplotWid subplotht])
    ...
    xticklabels(xticklabels1)
    xlabel('(d)');hold off;
    saveas(gcf,'longTerm_QZSS_sat_obs.png')

    % display the skyplot
    elev = elev_Q';azim = azim_Q';
    satSkyPlot(gnssId,elev,azim,sats)
    saveas(gcf, 'longTerm_QZSS_satSkyPlot.png')
end
...
subplot('position', [0.79 0.15 subplotWid subplotht])
    ...
    saveas(gcf,'longTerm_GLONASS_sat_obs.png')

    % display the skyplot
    elev = elev_R';azim = azim_R';
    satSkyPlot(gnssId,elev,azim,sats)
    saveas(gcf, 'longTerm_GLONASS_satSkyPlot.png')
end
...
figure(101);
set(gcf, 'Position', [50, 100, 1700, 750]);
% subplot(231)
...
saveas(gcf,'longTerm_PVT(P).png')

% 2. PVT(V)
subplotWid = 0.28;subplotht = 0.70;
fig = figure('Position', [50, 100, 1500, 400]);
